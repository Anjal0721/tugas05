...
<li class="nav-item">
      ...
      </li><!-- End <ul class="sidebar-nav" id="sidebar-nav">
      <li class="nav-item">
            ...
            <div class="card-body">
              ...
              <form class="row g-3"  method="POST">
                ...
                <div class="col-12">
                  ...
                  <input type="email" name="gmail" class="form-control" id="inputEmail4">
                </div>
                <div class="col-12">
                  <label for="input" class="form-label">Nomor hp</label>
                  <input type="text" name="nomor_hp" class="form-control" id="inputAddress">
                </div>
                <div class="col-12">
